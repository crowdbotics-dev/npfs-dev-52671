"""
Django settings for npfs_dev_52671 project.
...
ROOT_URLCONF = 'npfs_dev_52671.urls'
...
WSGI_APPLICATION = 'npfs_dev_52671.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "npfs_dev_52671 API",
    "DESCRIPTION": "API documentation for npfs_dev_52671 App",
    "VERSION": "v1",
}
